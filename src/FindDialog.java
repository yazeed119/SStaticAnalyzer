    ...
    private void find(String pattern) {
        if (!finishedFinding) {
            if (matcher.find()) {
                ...
                parents.textPane.moveCaretPosition(matcher.start());
                parents.textPane.select(selectionStart, selectionEnd);
            } else {
            ...
            matcher = Pattern.compile(pattern).matcher(parents.textPane.getText());
